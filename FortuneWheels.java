...
public class FortuneWheels {
    ...
    public void displayPhrase() {
        ...
        String tempPhrase = "";
        String errorMsg = "";
        String lastGuessedLetter = guessedLetter.substring(guessedLetter.length() - 1, guessedLetter.length());
        ...
        for(int i = 0; i < phrase.length(); i++) {
            ...
            if(!lastGuessedLetter.equals(letterToCheck)) {
                errorMsg = "Oops, look like " + "'" + lastGuessedLetter + "'" + " is not in the word!";
            }
        }
    ...
    public static void main(String[] args) {
        ...
        String answer = "mathematics";  //set your word here
        ...
        while(!userGuess.equals("stop")) {
            ...
            i++;
                if(answer.indexOf(userGuess) == -1) {
                    System.out.println("Oops, look like " + "'" + userGuess + "'" + " is not in the word!");
                }
